      ...
      if !(ocaml-ng ? "ocamlPackages_trunk") then
        {
            ...
            oself: osuper: {
              ocaml = osuper.ocaml.overrideAttrs (_: {
                src = super.fetchFromGitHub {
                  ...
                  repo = "ocaml";
                  rev = "4.14.4";
                  hash = "sha256-13E+TnS7hf+YZGG6Uh6yaFiAlDKJuGICRVARNBV9D7s=";
                };
          ...
          ocamlPackages_5_6 = newOCamlScope {
            ...
            src = super.fetchFromGitHub {
              owner = "ocaml";
              repo = "ocaml";
              rev = "44c3e7d2e494779fddfa4fa278a5c0d0f87feebe";
              hash = "sha256-EqlCvIWFaFMTqVlvZBUw38tbfg1XpAuzIWxlu96H9gY=";
              fetchSubmodules = true;
            };
          };
